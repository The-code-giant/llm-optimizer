 ...
 *   put:
 *     summary: Deploy content for a specific page and content type
 *     tags: [Pages]
 *     parameters:
 *       - in: path
 *         name: pageId
 ...
 *         description: Page not found or not authorized
 */
router.put('/:pageId/content/:contentType/deploy', authenticateJWT, pagesController.deployPageContent);

/**
 * @openapi
 * /api/v1/pages/{pageId}/content/{contentType}/undeploy:
 *   delete:
 *     summary: Undeploy content for a specific page and content type
 *     tags: [Pages]
 *     parameters:
 *       - in: path
 *         name: pageId
 ...
 *         description: Page not found or not authorized
 */
router.delete('/:pageId/content/:contentType/undeploy', authenticateJWT, pagesController.undeployPageContent);
