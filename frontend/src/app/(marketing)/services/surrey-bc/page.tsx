  ...
  const testimonials = [
    {
      ...
      text: "Our industrial content now gets cited by ChatGPT consistently. LLM Optimizer helped us optimize complex manufacturing documentation for AI understanding."
    },
    {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-normal mb-6 text-gray-900 leading-tight">
              How LLM Optimizer Works for Your Surrey Business
            </h2>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-normal mb-6 text-gray-900 leading-tight">
              Surrey Businesses Love Our LLM Optimizer
            </h2>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-12 leading-relaxed">
              Join 220+ Surrey companies already using LLM Optimizer to increase their AI citations and industrial content visibility.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/demo">
                <Button size="lg" className="bg-white text-black hover:bg-gray-100 rounded-full px-8 py-3">
