...
export default function Tutorials() {
  ...
  const tutorials = [
    {
      id: 1,
      title: "Getting Started with LLM Optimizer",
    ...
    },
    {
      ...
      description: "Complete guide to integrating LLM Optimizer via our REST API",
      duration: "22:15",
      category: "advanced",
      level: "Advanced",
      views: "5.8K",
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-12 leading-relaxed">
              Start applying what you've learned with a free LLM Optimizer account.
            </p>
